...
const HomeScreen = () => {
  const data = [
    ...
    },
    {
      ...
      description: 'Electra\'s Laptop is designed for users seeking a straightforward, no-frills computing experience. It\'s well-suited for everyday tasks like web browsing, checking email, and basic document editing. The laptop boasts a simple design, decent battery life, and sufficient storage for everyday use, making it a solid choice for students and casual users.'
    },
    {
      brandname: 'PixelPlus',
      ...
      description: 'The PixelPlus Smartwatch is an innovative device that keeps you connected and healthy. This smartwatch not only seamlessly syncs with your smartphone for notifications but also includes features like fitness tracking, heart rate monitoring, and GPS. Its stylish design and durable build make it suitable for both everyday wear and sports activities.'
    },
    {
      ...
      description: 'Innovatech Tablet offers a remarkable combination of affordability and efficiency. With a user-friendly interface and a long-lasting battery, it\'s perfect for reading e-books, browsing the internet, and watching videos. Its lightweight design and portable size make it an excellent choice for on-the-go users who need a reliable device for media consumption and light work.'
    },
    {
      brandname: 'SoundWave',
      ...
      description: 'SoundWave Headphones are designed for audiophiles who appreciate deep, rich sound and comfort. These headphones offer an immersive audio experience, perfect for enjoying music, podcasts, and movies. With features like noise cancellation and a comfortable over-ear design, they provide a premium listening experience for extended periods.'
    },
    {
      brandname: 'Visionary',
      gadgettype: 'Laptop',
